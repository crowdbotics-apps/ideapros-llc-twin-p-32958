...
## Project Structure
    ...
    ├── ideapros_llc_twin_p_32958  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_twin_p_32958`
...
2. Clone this repo and `cd ideapros_llc_twin_p_32958`
